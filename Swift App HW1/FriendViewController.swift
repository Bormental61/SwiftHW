...
final class FriendViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.tap = { [weak self] text, photo in self?.navigationController?
                                            .pushViewController(ProfileViewController(name: text, photo: photo, 
                                                                                    isUserProfile: false), animated: true)
        }
        return cell
    }
...
private extension FriendViewController {
    func showAlert() {
        ...
        let alert = UIAlertController(title: "Didn't manage get data", message: "Data actual on \(date)", preferredStyle: .alert)
