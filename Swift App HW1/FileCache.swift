...
final class FileCache {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        persistentContainer.loadPersistentStores(completionHandler: { (_, error) in if let error = error {print(error)}})
    ...
    func fetchFriends() -> [Friend] {
        ...
        for friend in friends {
            newFriends.append(Friend(id: Int(friend.id), firstName: friend.firstName, lastName: friend.lastName, photo: friend.photo,
